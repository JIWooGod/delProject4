...
<table cellpadding="0" cellspacing="0" align="center">
	<tr><td><h2>주문리스트</h2></td></tr>
	<c:forEach var="sl" items="${shipList }" varStatus="status">
	<tr><td>주문자 : ${sl.odName } &nbsp;&nbsp; 배송방법 : ${sl.shipMtd } &nbsp;&nbsp; 체크인 : ${sl.chkIn } &nbsp;&nbsp; 호실 : ${sl.rmNo} &nbsp;&nbsp; 
	송장번호 : <input type="text" ><button type="submit" ><a href="sendShip" ></a>발송</button></td></tr>
	</c:forEach>
