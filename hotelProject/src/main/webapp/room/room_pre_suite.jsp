...
<div id='content_wrapper'>
	...
	<div class='sub_menu'>
		<div class='box'>
		<span class='subMENUout'><a href='standard'>스탠다드</a></span><span class='subMENUout'><a href='deluxe'>디럭스</a></span><span class='subMENUout'><a href='deluxeSuite'>디럭스 스위트</a></span><span class='subMENUout'><a href='royalSuite'>로열 스위트</a></span><span class='subMENUon'><a href='preSuite'>프리미어 스위트</a></span>		</div>

		<div class='tl'>
			<div class='line'></div>
			<div class='title'>프리미어 스위트</div>
			<div class='line'></div>
		</div>
	</div>
...
청명한 하늘과 닿은 한강 풍경을 바라보며 스파를 즐길 수 있는 프리미어 스위트는
다양한 기능을 충족시켜주는 넓은 거실과 두 개의 침실로 이루어진 객실입니다.
</div>
<div class='sub_room'>
	<!--객실미리보기시작-->
	<div id="main_bn">
		<div class="flexslider">
			...
			<li><img src='./room/img/suiteroom1.jpg'></li>
			<li><img src='./room/img/suiteroom2.jpg'></li>
			<li><img src='./room/img/suiteroom3.jpg'></li>
			<li><img src='./room/img/suiteroom4.jpg'></li>
			</ul>
		</div>
	</div>
...
<a href='reservation?room=preSuite'>
